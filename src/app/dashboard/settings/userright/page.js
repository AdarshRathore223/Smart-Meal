  ...
  return (
    <div className="w-full h-full bg-white m-3 rounded-md p-2 pt-4 border">
      <div className="flex justify-between">
        <h1 className="font-extrabold text-xl mb-10">User Right & Controls</h1>
        <a
          ...
          {rights.map((item, index) => (
            ...
            >
              ...
              <div className="w-full flex gap-2 justify-start">
                <a href="./userright/addrole" className="aspect-square rounded-full bg-white h-10 w-10 flex justify-center items-center shadow-lg">
