...
function page() {
  const {
    ...
    loading,
    error,
  } = useFetchData("https://ziounbe.onrender.com/products");
                ...
                <AlertDialogHeader>
                  ...
                  <form>
                    <div className="flex flex-col p-4 gap-2">
                      ...
                      <div className="text-xs font-bold">Main</div>
                      ...
                      <Dropdown placeholder="Pricelist" />
                      <div className="flex items-center font-bold -ml-2">
                        <CheckboxButton />
                        <div className="ml-8 text-xs ">Not in Pricelist</div>
                      </div>
                    </div>
                  </form>
                </AlertDialogHeader>
        ...
        <div className="border border-opacity-25 p-4 my-4 rounded-md">
          ...
          <div className="h-96 overflow-y-scroll">
            {productData.map((item, index) => (
              ...
              >
                <a
                  href={`./productlist/[${item.code}]`}
                  className="text-start w-[14%] text-[#538dec] underline"
                >
                  {item.group || "-"}
                </a>
                <a
